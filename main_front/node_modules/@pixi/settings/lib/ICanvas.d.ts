...
export declare type PredefinedColorSpace = 'srgb' | 'display-p3';
export declare type RenderingContext = ICanvasRenderingContext2D | ImageBitmapRenderingContext | WebGLRenderingContext | WebGL2RenderingContext;
